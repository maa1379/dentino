...
class NeumorphicContainer extends StatelessWidget {
  NeumorphicContainer({
    ...
    Color color,
    MyNeumorphicDecoration decoration,
    this.alignment,
    this.width,
    this.height,
    ...
    this.transform,
    Key key,
  })  : decoration = decoration ?? MyNeumorphicDecoration(color: color),
  ...
  /// argument.
  final MyNeumorphicDecoration decoration;
...
class MyNeumorphicDecoration {
  const MyNeumorphicDecoration({
    this.color,
    this.borderRadius,

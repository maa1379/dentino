...
class MyTurnScreen extends StatelessWidget {
  ...
  reserveListController ReserveListController =
      Get.put(reserveListController());
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: GestureDetector(
                  onTap: () {
                    ReserveListController.deleteReserve(
                        reserve_id: item.id.toString());
                    EasyLoading.show(
              ...
              GestureDetector(
                onTap: () {
                  Get.to(() => DoctorProfile(), arguments: {
                    "doctorProfile_id": item.doctorId.toString()
                  });
                },
                child: Container(
                  height: size.height * .04,

...
class WidgetHelper {
  static Widget textField({
    ...
    return Directionality(
      ...
      child: Container(
        ...
        //   border: Border.all(color: ColorsHelper.mainColor, width: 3),
        // ),
        child: TextFormField(
          enabled: enabled,
          onChanged: onChange,
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(15),
              borderSide: BorderSide(color: ColorsHelper.mainColor,width: 3)
            ),
            ...
            // labelText: text,
            hintText: hintText,
            contentPadding: EdgeInsets.only(top: size.width * .01),
            counter: Offstage(),
            errorText: errorText,
            filled: true,
  ...
  static Widget profileTextField({
    String text,
    TextEditingController controller,
    double height,
    double width,
      ...
      child: Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: text,
            hintText: hintText,
            contentPadding: EdgeInsets.only(top: size.width * .01,right: size.width * .05),
            counter: Offstage(),
            errorText: errorText,
            filled: true,
